...
ipar_noise = find(strcmpi(pnam,'sigma_inf'));
...
out.cfg = cfg;
    ...
    %-------------------------------------
    function [pt,lt,ut,st,wt] = getp(h,sigma_inf,sigma_sel)
